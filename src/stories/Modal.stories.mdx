...
Passing `shouldCloseOnOverlayClick={false}` disables closing the modal on overlay click, if that feels risky to you.
        ...
        <>
          ...
          >
            ...
            >
              ...
              <div class="dark-environment">
                <Button color="secondary" hideIcon>
                  Delete Internet
                </Button>
              </div>
            </div>
